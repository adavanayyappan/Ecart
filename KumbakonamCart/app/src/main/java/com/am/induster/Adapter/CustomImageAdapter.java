...
public class CustomImageAdapter extends PagerAdapter {
    ...
    public CustomImageAdapter(Context mContext, ArrayList<Products> products) {
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        ...
        Picasso.with(mContext).load(mProducts.get(position).getImage()).fit().centerCrop().into(imgV);
        imgV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mContext, AdminBannerActivity.class);
